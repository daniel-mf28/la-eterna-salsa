      ...
      <div className="flex-1 min-w-0 flex flex-col justify-center gap-2 sm:gap-2.5 px-4 sm:px-5 py-3 sm:py-4">
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          ...
          <button
            ...
            className="w-11 h-11 rounded-full bg-[#0A3538] text-white flex items-center justify-center hover:bg-[#0A3538]/80 transition-colors disabled:cursor-wait flex-shrink-0"
          >
            {isLoading ? (
          ...
          <button
            ...
            className="text-[#0A3538] hover:text-[#C2491F] transition-colors flex-shrink-0"
          ...
          {/* Volume slider — always visible, inline */}
          <input
            type="range"
            min="0"
            max="1"
            ...
            className="flex-1 h-1.5 accent-[#C2491F] cursor-pointer max-w-[140px]"
            aria-label="Volumen"
          />
        </div>
